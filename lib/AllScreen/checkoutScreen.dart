...
class CheckoutScreen extends StatelessWidget {
  ...
  static String idScreen = "/checkoutScreen";
                        ...
                        SizedBox(
                          ...
                          child: TextField(
                            decoration: InputDecoration(
                              //labelText: "Address",
                              labelStyle: Helper.getTheme(context).headline3,
                              hintText: "Enter your address",
                              hintStyle: Helper.getTheme(context).bodyText2,
                        ...
                        TextButton(
                          onPressed: () {
                            Navigator.of(context)
                                .pushNamed(ChangeAddressScreen.idScreen);
                          },
                          child: Text(
                            "GPS location",
                            style: TextStyle(
